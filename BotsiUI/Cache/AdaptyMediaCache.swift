...
@MainActor
extension BotsiUI {
    static let imageCache = ImageCache(name: "Botsi")
    static let imageDownloader = ImageDownloader(name: "Botsi")
...
extension BotsiUI {
    @MainActor
    final class ImageUrlPrefetcher: BotsiImageUrlObserver {
        ...
        func initialize() {
            ...
            Botsi.setImageUrlObserver(self)
        }
