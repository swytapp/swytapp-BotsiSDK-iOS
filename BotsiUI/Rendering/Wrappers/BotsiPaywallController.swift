...
public final class BotsiPaywallController: UIViewController {
    public let id = UUID()

    let paywallConfiguration: BotsiUI.PaywallConfiguration
    let showDebugOverlay: Bool

    public weak var delegate: BotsiPaywallControllerDelegate?
