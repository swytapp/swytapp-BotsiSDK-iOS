//
//  BotsiPaywallView_Internal.swift
//
//
...
public struct BotsiIdentifiablePlaceholder: Identifiable {
    public var id: String { "placeholder" }
}

@available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
@MainActor
struct BotsiPaywallView_Internal<AlertItem>: View where AlertItem: Identifiable {
    @EnvironmentObject private var productsViewModel: BotsiProductsViewModel
