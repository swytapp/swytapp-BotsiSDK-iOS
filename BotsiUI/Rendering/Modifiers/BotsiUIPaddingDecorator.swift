...
extension View {
    @ViewBuilder
    func padding(_ insets: VC.EdgeInsets?) -> some View {
        if let insets {
            modifier(BotsiUIPaddingDecorator(insets: insets))
        } else {
            self
        }
    }
