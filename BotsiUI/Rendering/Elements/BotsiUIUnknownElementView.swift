//
//  BotsiUIUnknownElementView.swift
//
//
...
@available(macOS 10.15, iOS 13.0, *)
struct BotsiUIUnknownElementView: View {
    var value: String

//    @ViewBuilder
//    private func debugView(_ element: BotsiUI.DebugElement) -> some View {
//        element.shape
...
@available(macOS 10.15, iOS 13.0, *)
#Preview {
    BotsiUIUnknownElementView(value: VC.DebugElement.rectangle.rawValue)
}
