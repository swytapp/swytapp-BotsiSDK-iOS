...
public struct BotsiProfileParameters: Sendable, Hashable {
    public internal(set) var firstName: String?
    public internal(set) var lastName: String?
    public internal(set) var gender: BotsiProfile.Gender?
    ...
    public internal(set) var appTrackingTransparencyStatus: BotsiProfileParameters.AppTrackingTransparencyStatus?

    var codableCustomAttributes: BotsiProfile.CustomAttributes?
    ...
    init(customAttributes: BotsiProfile.CustomAttributes) {
        codableCustomAttributes = customAttributes
    }
}

extension BotsiProfileParameters {
    public static let empty: BotsiProfileParameters = .init()
    public func builder() -> Builder { Builder(self) }
}

extension BotsiProfileParameters: Codable {
