//
//  BotsiProfile.AccessLevel.swift
//  BotsiSDK
//
...
extension BotsiProfile {
    public struct AccessLevel: Sendable, Hashable {
        /// Unique identifier of the access level configured by you in Botsi Dashboard.
...
extension BotsiProfile.AccessLevel: CustomStringConvertible {
...
extension BotsiProfile.AccessLevel: Codable {
