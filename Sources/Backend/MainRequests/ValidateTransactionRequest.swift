...
private struct ValidateTransactionRequest: HTTPEncodableRequest, HTTPRequestWithDecodableResponse {
    typealias ResponseBody = Backend.Response.ValueOfData<BotsiProfile>
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try dataObject.encode("botsi_purchase_app_store_original_transaction_id_validation_result", forKey: .type)
        ...
        case let .restore(originalTransactionId):
            ...
            try attributesObject.encode(Botsi.ValidatePurchaseReason.restoreRawString, forKey: .requestSource)
            try attributesObject.encode(originalTransactionId, forKey: .originalTransactionId)
        case let .report(transactionId, variationId):
            var attributesObject = dataObject.nestedContainer(keyedBy: CodingKeys.self, forKey: .attributes)
            try attributesObject.encode(profileId, forKey: .profileId)
            try attributesObject.encode(Botsi.ValidatePurchaseReason.reportRawString, forKey: .requestSource)
    ...
    enum RequestSource: Sendable {
        ...
        case other(PurchasedTransaction, reason: Botsi.ValidatePurchaseReason)
    }
}

private extension Botsi.ValidatePurchaseReason {
...
extension Backend.MainExecutor {
    func syncTransaction(
        ...
        let logParams: EventParameters = [
            ...
            "request_source": Botsi.ValidatePurchaseReason.restoreRawString,
        ]
    ...
    func reportTransaction(
        ...
        let logParams: EventParameters = [
            ...
            "request_source": Botsi.ValidatePurchaseReason.reportRawString,
        ]
