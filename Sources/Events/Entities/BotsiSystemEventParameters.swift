//
//  BotsiSystemEventParameters.swift
//  BotsiSDK
//
...
package protocol BotsiSystemEventParameters: Sendable, Encodable {}
...
struct BotsiBackendAPIRequestParameters: BotsiSystemEventParameters {
...
struct BotsiBackendAPIResponseParameters: BotsiSystemEventParameters {
    let name: APIRequestName
    let stamp: String
...
struct BotsiSDKMethodRequestParameters: BotsiSystemEventParameters {
    let name: MethodName
    let stamp: String
    let params: EventParameters?
...
struct BotsiSDKMethodResponseParameters: BotsiSystemEventParameters {
    let name: MethodName
    let stamp: String?
    let params: EventParameters?
    let error: String?
...
struct BotsiAppleRequestParameters: BotsiSystemEventParameters {
...
struct BotsiAppleResponseParameters: BotsiSystemEventParameters {
    let name: AppleMethodName
    let stamp: String?
    let params: EventParameters?
    let error: String?
...
struct BotsiAppleEventQueueHandlerParameters: BotsiSystemEventParameters {
...
struct BotsiInternalEventParameters: BotsiSystemEventParameters {
    let eventName: String
    let params: EventParameters?
    let error: String?
