//
//  BotsiConfiguration.Builder+Decodable.swift
//  BotsiSDK
//
...
extension BotsiConfiguration.Builder: Decodable {
    ...
    public convenience init(from decoder: Decoder) throws {
        ...
        try self.init(
            ...
            serverCluster: container.decodeIfPresent(BotsiConfiguration.ServerCluster.self, forKey: .serverCluster),
            ...
            backendProxy: proxy,
            logLevel: container.decodeIfPresent(BotsiLog.Level.self, forKey: .logLevel),
            crossPlatformSDK: crossPlatformSDK
        )
    }
}

extension BotsiConfiguration.ServerCluster: Decodable {
