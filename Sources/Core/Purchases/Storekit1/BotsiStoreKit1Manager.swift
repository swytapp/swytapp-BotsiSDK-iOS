...
//        await BotsiPaymentTransaction(transactionId: tra, originalTransactionId: <#T##String#>, vendorProductId: <#T##String#>, productVariationId: <#T##String?#>, persistentProductVariationId: <#T##String?#>, price: <#T##Decimal?#>, priceLocale: <#T##String?#>, storeCountry: <#T##String?#>, subscriptionOffer: <#T##BotsiSubscriptionOffer?#>, environment: <#T##String?#>)
//    }
//    
//    @available(iOS 15, *)
