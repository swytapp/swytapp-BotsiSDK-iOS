...
extension BotsiError {
    public static let BotsiErrorDomain = "BotsiErrorDomain"
    public static let HTTPErrorDomain = "BotsiHTTPErrorDomain"
    public static let EventsErrorDomain = "BotsiEventsErrorDomain"
    public static let SKManagerErrorDomain = "BotsiSKManagerErrorDomain"

    public enum UserInfoKey {
        public static let description = NSDebugDescriptionErrorKey
        public static let source = "BotsiSourceErrorKey"
        public static let endpoint = "BotsiHTTPEndpointErrorKey"
        public static let statusCode = "BotsiHTTPStatusCodeErrorKey"
    }
...
public struct BotsiError: CustomNSError, CustomStringConvertible, CustomDebugStringConvertible {
    public static let errorDomain = BotsiErrorDomain

    let wrapped: CustomBotsiError
