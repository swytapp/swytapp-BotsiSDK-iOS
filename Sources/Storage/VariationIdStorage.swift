...
final class VariationIdStorage: Sendable {
    ...
    private enum Constants {
        static let variationsIds = "BotsiSDK_Cached_Variations_Ids"
        static let persistentVariationsIds = "BotsiSDK_Variations_Ids"
    }
    ...
    nonisolated func setVariationIds(_ variationId: String?, for productId: String) async {
        ...
        Task {
            if await setVariationId(variationId, for: productId) {
                await Botsi.trackSystemEvent(BotsiInternalEventParameters(
