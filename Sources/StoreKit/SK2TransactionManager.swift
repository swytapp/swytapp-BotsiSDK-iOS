...
actor SK2TransactionManager: StoreKitTransactionManager {
    ...
    private func syncLastTransaction(for profileId: String) async throws -> VH<BotsiProfile>? {
        defer { syncing = nil }
        ...
        do {
            ...
            throw error.asBotsiError ?? BotsiError.syncLastTransactionFailed(unknownError: error)
        }
    }
    ...
    private static var lastTransaction: SK2Transaction? {
        get async {
            ...
            await Botsi.trackSystemEvent(BotsiAppleRequestParameters(methodName: .getAllSK2Transactions, stamp: stamp))
            ...
            await Botsi.trackSystemEvent(BotsiAppleResponseParameters(methodName: .getAllSK2Transactions, stamp: stamp, params: params))
