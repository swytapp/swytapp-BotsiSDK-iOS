        ...
        if let discountIdentifier = sk1Transaction.unfOfferId {
            if let sk2ProductOffer = sk2Product?.subscriptionOffer(byType: .promotional, withId: discountIdentifier) {
                self.init(
                    ...
                    period: sk2ProductOffer.period.asBotsiSubscriptionPeriod,
            ...
            self.init(
                id: nil,
                period: offer.period.asBotsiSubscriptionPeriod,
    ...
    init?(
        ...
        init?(
            ...
            self = .init(
                ...
                period: (sk2ProductOffer?.period).map { $0.asBotsiSubscriptionPeriod },
