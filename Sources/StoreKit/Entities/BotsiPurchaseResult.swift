...
public enum BotsiPurchaseResult: Sendable {
    ...
    case pending
    /// The purchase succeeded with a `BotsiProfile`.
    case success(profile: BotsiProfile, transaction: any Sendable)
    ...
    /// An ``BotsiProfile`` which contains the up-to-date inforation about the user.
    @inlinable
    public var profile: BotsiProfile? {
