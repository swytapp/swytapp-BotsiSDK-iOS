...
extension BotsiViewConfiguration.ShapeType: Hashable {
...
extension BotsiViewConfiguration.ShapeType: Decodable {
    enum Types: String {
        case circle
        case rectangle = "rect"
    ...
    package init(from decoder: Decoder) throws {
        ...
        case .curveDown:
            self = .curveDown
        case .rectangle:
            self = .rectangle(cornerRadius: BotsiViewConfiguration.CornerRadius.zero)
        case .circle:
            self = .circle
        }
    }
