...
#if DEBUG
    package extension BotsiViewConfiguration.CornerRadius {
        static func create(
...
extension BotsiViewConfiguration.CornerRadius {
    package static let zero = BotsiViewConfiguration.CornerRadius(same: 0.0)
...
extension BotsiViewConfiguration.CornerRadius: Decodable {
    ...
    package init(from decoder: Decoder) throws {
        ...
        let defaultValue = BotsiViewConfiguration.CornerRadius.defaultValue
